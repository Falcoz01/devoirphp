...
<main>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div class="col">
          ...
          <img src= "'.$image.'" class="card-img-top" alt="...">
            ...
            <div class="card-body">
            <h5 class="card-title">'.$titre.'/ id='.$id.'</h5>
              <p class="card-text">'.$description.'</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                <form action="delete_controller.php" method="POST">
                <button type="submit" class="btn btn-primary" name="button1" >Delete</button>
                ...
                <form action="../controller/show_controller.php" method="POST">
                <button type="submit" class="btn btn-primary" name="button2" >show</button>
                <input type=hidden name=id value='.$row['id'].'>
                </form>
  ...
  echo '<form action="../vue/create2.php" method="POST">
<button type="submit" class="btn btn-primary" name="button3" >New</button>
<input type=hidden name=id value='.$row['id'].'>
</form>';
  ?>
